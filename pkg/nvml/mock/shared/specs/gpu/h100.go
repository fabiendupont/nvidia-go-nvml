...
// H100Spec defines the GPU specification for NVIDIA H100-SXM5-80GB
var H100Spec = shared.GPUSpec{
	Name:                "NVIDIA H100 80GB HBM3",
	Architecture:        nvml.DEVICE_ARCH_HOPPER,
	Brand:               nvml.BRAND_TESLA,
	PciDeviceId:         shared.H100_PCI_DEVICE_ID,
	PciBusIDBase:        "0000:17:%02x:00.0", // H100 uses bus 0x17:0x00-0x07
	...
	CudaCapabilityMajor: shared.H100_CUDA_MAJOR,
	CudaCapabilityMinor: shared.H100_CUDA_MINOR,
	TotalMemoryMB:       shared.H100_TOTAL_MEMORY_MB,
	MIGProfiles:         H100MIGProfiles,
}

// H100MIGProfiles defines the complete MIG profile configuration for H100
var H100MIGProfiles = shared.MIGProfileConfig{
	GpuInstanceProfiles: map[int]nvml.GpuInstanceProfileInfo{
		...
		nvml.GPU_INSTANCE_PROFILE_1_SLICE: {
			...
			IsP2pSupported:      shared.H100_MIG_P2P_SUPPORT,
			SliceCount:          1,
			InstanceCount:       shared.MIG_1_SLICE_INSTANCE_COUNT,
			MultiprocessorCount: shared.H100_MIG_1_SLICE_SM_COUNT,
			CopyEngineCount:     shared.H100_MIG_1_SLICE_CE_COUNT,
			DecoderCount:        1,
			EncoderCount:        0,
			JpegCount:           0,
			OfaCount:            0,
			MemorySizeMB:        shared.H100_MIG_1G_10GB_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_2_SLICE: {
			...
			MultiprocessorCount: shared.H100_MIG_2_SLICE_SM_COUNT,
			CopyEngineCount:     shared.H100_MIG_2_SLICE_CE_COUNT,
			DecoderCount:        2,
			EncoderCount:        1,
			JpegCount:           0,
			OfaCount:            0,
			MemorySizeMB:        shared.H100_MIG_2G_20GB_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_3_SLICE: {
			...
			MultiprocessorCount: shared.H100_MIG_3_SLICE_SM_COUNT,
			CopyEngineCount:     shared.H100_MIG_3_SLICE_CE_COUNT,
			DecoderCount:        3,
			EncoderCount:        2,
			JpegCount:           0,
			OfaCount:            0,
			MemorySizeMB:        shared.H100_MIG_3G_40GB_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_4_SLICE: {
			...
			MultiprocessorCount: shared.H100_MIG_4_SLICE_SM_COUNT,
			CopyEngineCount:     shared.H100_MIG_4_SLICE_CE_COUNT,
			DecoderCount:        4,
			EncoderCount:        3,
			JpegCount:           0,
			OfaCount:            0,
			MemorySizeMB:        shared.H100_MIG_4G_40GB_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_6_SLICE: {
			...
			SliceCount:          6,
			InstanceCount:       1,
			MultiprocessorCount: shared.H100_MIG_6_SLICE_SM_COUNT,
			CopyEngineCount:     shared.H100_MIG_6_SLICE_CE_COUNT,
			DecoderCount:        6,
			EncoderCount:        5,
			JpegCount:           1,
			OfaCount:            1,
			MemorySizeMB:        shared.H100_MIG_6G_60GB_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_7_SLICE: {
			...
			MultiprocessorCount: shared.H100_MIG_7_SLICE_SM_COUNT,
			CopyEngineCount:     shared.H100_MIG_7_SLICE_CE_COUNT,
			DecoderCount:        7,
			EncoderCount:        7,
			JpegCount:           1,
			OfaCount:            1,
			MemorySizeMB:        shared.H100_MIG_7G_80GB_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_8_SLICE: {
			...
			SliceCount:          8,
			InstanceCount:       1,
			MultiprocessorCount: shared.H100_MIG_8_SLICE_SM_COUNT,
			CopyEngineCount:     shared.H100_MIG_8_SLICE_CE_COUNT,
			DecoderCount:        8,
			EncoderCount:        7,
			JpegCount:           1,
			OfaCount:            1,
			MemorySizeMB:        shared.H100_MIG_8G_80GB_MEMORY_MB,
		},
		// Revision variants
		nvml.GPU_INSTANCE_PROFILE_1_SLICE_REV1: {
			...
			JpegCount:           1,
			OfaCount:            1,
			MemorySizeMB:        shared.H100_MIG_1G_REV1_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_2_SLICE_REV1: {
			...
			JpegCount:           0,
			OfaCount:            0,
			MemorySizeMB:        shared.H100_MIG_2G_REV1_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_1_SLICE_REV2: {
			...
			JpegCount:           0,
			OfaCount:            0,
			MemorySizeMB:        shared.H100_MIG_1G_REV2_MEMORY_MB,
		},
		// Graphics variants
		nvml.GPU_INSTANCE_PROFILE_1_SLICE_GFX: {
			...
			JpegCount:           1,
			OfaCount:            1,
			MemorySizeMB:        shared.H100_MIG_1G_GFX_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_2_SLICE_GFX: {
			...
			JpegCount:           1,
			OfaCount:            1,
			MemorySizeMB:        shared.H100_MIG_2G_GFX_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_4_SLICE_GFX: {
			...
			JpegCount:           1,
			OfaCount:            1,
			MemorySizeMB:        shared.H100_MIG_4G_GFX_MEMORY_MB,
		},
		...
		nvml.GPU_INSTANCE_PROFILE_1_SLICE_NO_ME: {
			...
			JpegCount:           0,
			OfaCount:            0,
			MemorySizeMB:        shared.H100_MIG_1G_NO_ME_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_2_SLICE_NO_ME: {
			...
			JpegCount:           0,
			OfaCount:            0,
			MemorySizeMB:        shared.H100_MIG_2G_NO_ME_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_1_SLICE_ALL_ME: {
			...
			InstanceCount:       shared.MIG_1_SLICE_INSTANCE_COUNT,
			MultiprocessorCount: shared.H100_MIG_1_SLICE_SM_COUNT,
			CopyEngineCount:     shared.H100_MIG_1_SLICE_CE_COUNT * 2, // All memory engines
			DecoderCount:        2,
			EncoderCount:        2,
			JpegCount:           1,
			OfaCount:            1,
			MemorySizeMB:        shared.H100_MIG_1G_ALL_ME_MEMORY_MB,
		},
		nvml.GPU_INSTANCE_PROFILE_2_SLICE_ALL_ME: {
			...
			InstanceCount:       shared.MIG_2_SLICE_INSTANCE_COUNT,
			MultiprocessorCount: shared.H100_MIG_2_SLICE_SM_COUNT,
			CopyEngineCount:     shared.H100_MIG_2_SLICE_CE_COUNT * 2, // All memory engines
			DecoderCount:        4,
			EncoderCount:        4,
			JpegCount:           1,
			OfaCount:            1,
			MemorySizeMB:        shared.H100_MIG_2G_ALL_ME_MEMORY_MB,
		},
	},
	ComputeInstanceProfiles: map[int]map[int]nvml.ComputeInstanceProfileInfo{
		...
		nvml.GPU_INSTANCE_PROFILE_1_SLICE: {
			nvml.COMPUTE_INSTANCE_PROFILE_1_SLICE: {
				...
				InstanceCount:         1,
				MultiprocessorCount:   shared.H100_MIG_1_SLICE_SM_COUNT,
				SharedCopyEngineCount: shared.H100_MIG_1_SLICE_CE_COUNT,
		...
		nvml.GPU_INSTANCE_PROFILE_2_SLICE: {
			...
			nvml.COMPUTE_INSTANCE_PROFILE_2_SLICE: {
				...
				InstanceCount:         1,
				MultiprocessorCount:   shared.H100_MIG_2_SLICE_SM_COUNT,
				SharedCopyEngineCount: shared.H100_MIG_2_SLICE_CE_COUNT,
		...
		nvml.GPU_INSTANCE_PROFILE_3_SLICE: {
			...
			nvml.COMPUTE_INSTANCE_PROFILE_3_SLICE: {
				...
				InstanceCount:         1,
				MultiprocessorCount:   shared.H100_MIG_3_SLICE_SM_COUNT,
				SharedCopyEngineCount: shared.H100_MIG_3_SLICE_CE_COUNT,
		...
		nvml.GPU_INSTANCE_PROFILE_4_SLICE: {
			...
			nvml.COMPUTE_INSTANCE_PROFILE_4_SLICE: {
				...
				InstanceCount:         1,
				MultiprocessorCount:   shared.H100_MIG_4_SLICE_SM_COUNT,
				SharedCopyEngineCount: shared.H100_MIG_4_SLICE_CE_COUNT,
		...
		nvml.GPU_INSTANCE_PROFILE_6_SLICE: {
			nvml.COMPUTE_INSTANCE_PROFILE_6_SLICE: {
				...
				InstanceCount:         1,
				MultiprocessorCount:   shared.H100_MIG_6_SLICE_SM_COUNT,
				SharedCopyEngineCount: shared.H100_MIG_6_SLICE_CE_COUNT,
		...
		nvml.GPU_INSTANCE_PROFILE_7_SLICE: {
			nvml.COMPUTE_INSTANCE_PROFILE_7_SLICE: {
				...
				InstanceCount:         1,
				MultiprocessorCount:   shared.H100_MIG_7_SLICE_SM_COUNT,
				SharedCopyEngineCount: shared.H100_MIG_7_SLICE_CE_COUNT,
		...
		nvml.GPU_INSTANCE_PROFILE_8_SLICE: {
			nvml.COMPUTE_INSTANCE_PROFILE_8_SLICE: {
				...
				InstanceCount:         1,
				MultiprocessorCount:   shared.H100_MIG_8_SLICE_SM_COUNT,
				SharedCopyEngineCount: shared.H100_MIG_8_SLICE_CE_COUNT,
		...
		nvml.GPU_INSTANCE_PROFILE_1_SLICE_ALL_ME: {
			nvml.COMPUTE_INSTANCE_PROFILE_1_SLICE: {
				...
				InstanceCount:         1,
				MultiprocessorCount:   shared.H100_MIG_1_SLICE_SM_COUNT,
				SharedCopyEngineCount: shared.H100_MIG_1_SLICE_CE_COUNT * 2, // All memory engines
				SharedDecoderCount:    2,
				SharedEncoderCount:    2,
				SharedJpegCount:       1,
				SharedOfaCount:        1,
		...
		nvml.GPU_INSTANCE_PROFILE_2_SLICE_ALL_ME: {
			nvml.COMPUTE_INSTANCE_PROFILE_2_SLICE: {
				...
				InstanceCount:         1,
				MultiprocessorCount:   shared.H100_MIG_2_SLICE_SM_COUNT,
				SharedCopyEngineCount: shared.H100_MIG_2_SLICE_CE_COUNT * 2, // All memory engines
				SharedDecoderCount:    4,
				SharedEncoderCount:    4,
				SharedJpegCount:       1,
				SharedOfaCount:        1,
